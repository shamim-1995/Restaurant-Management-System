            ...
            <div class="row min-vh-100 bg-black">
              <div class="scrollable-table">
                <table class="table table-dark table-striped align-middle">
                  ...
                  <tr>
                      <td>{{$result->title}}</td>
                      <td>{!! substr($result->description, 0, 150) !!}...</td>
                      <td><img class="resize" src="/blog_picture/{{ $result->image }}" alt=""></td>
                      <td><a onclick="return confirm('Are You Sure To Delete This')" class="ms-1" href="{{ url('delete_blog', $result->id) }}"><svg fill="#FFFFFF" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
